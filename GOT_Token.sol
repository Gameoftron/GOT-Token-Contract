...
// Decimals       : 6
//
//  Copyright (c) 2020 by Games of tron Tron Token (www.gamesoftron.com) 
// ----------------------------------------------------------------------------
...
contract ERC20Interface {
    ...
    // ------------------------------------------------------------------------
contract GOT is ERC20Interface{
    string public name = "GOT Token";
    ...
    event Approval(address indexed tokenOwner, address indexed spender, uint tokens);
    // ------------------------------------------------------------------------
    // Constructor With 50 000 supply, All deployed tokens sent to Main wallet
    // ------------------------------------------------------------------------
    constructor() public{
        supply = 50000000000;
        founder = msg.sender;
